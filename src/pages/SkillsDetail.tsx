  ...
  return (
    <div className="bg-white text-slate-700">
      <section className="relative flex min-h-[320px] items-end">
        ...
        />
        <div className="pointer-events-none absolute inset-0 bg-gradient-to-br from-white/96 via-white/92 to-[#E9F6FF]/88" aria-hidden />
            ...
            <div className="grid gap-6 lg:grid-cols-[1.1fr,0.9fr]">
              ...
              >
                <img
                  ...
                  loading="lazy"
                />
                <div className="pointer-events-none absolute inset-0 rounded-[28px] bg-gradient-to-t from-cyan-900/20 via-transparent to-transparent" />
              </motion.div>
            </div>
          </motion.article>
        </div>
