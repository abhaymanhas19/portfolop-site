        ...
        <div className="relative mx-auto flex w-full max-w-6xl flex-col gap-6 px-4 pb-12 pt-24 md:px-6 lg:px-8">
          ...
          >
            <div className="max-w-3xl space-y-4">
              ...
              <h1 className="text-3xl font-semibold text-slate-900 md:text-5xl">{aboutContent.headline}</h1>
            </div>
            <div className="flex gap-3">
              ...
              <Link
                to="/#contact"
                className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-cyan-400 via-teal-400 to-emerald-400 px-5 py-2.5 text-sm font-semibold text-slate-900 shadow-[0_18px_48px_rgba(79,209,197,0.35)] transition hover:-translate-y-0.5"
              >
                Start a project
              </Link>
            </div>
          ...
          <div className="grid gap-6 px-6 py-10 md:grid-cols-[1.1fr,1fr] md:px-10">
            ...
            >
              <img
                ...
                loading="lazy"
              />
              <div className="absolute inset-0 rounded-[28px] bg-gradient-to-t from-amber-900/25 via-transparent to-transparent" />
            </motion.div>
          </div>
        </section>
      </section>
