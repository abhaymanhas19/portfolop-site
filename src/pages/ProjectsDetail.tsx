      ...
      <section className="mx-auto max-w-6xl px-4 py-20 md:px-6 md:py-24 lg:px-8">
        ...
        >
          ...
          <div className="flex flex-col gap-3 md:items-end">
            ...
            <Link
              to="/#contact"
              className="inline-flex items-center justify-center rounded-full bg-[#FF6B35] px-5 py-2.5 text-sm font-semibold text-black shadow-[0_12px_34px_rgba(255,90,28,0.5)] transition hover:shadow-[0_16px_42px_rgba(255,90,28,0.55)]"
            >
        ...
        <motion.div
          ...
          className="mt-16 flex flex-col items-start gap-4 rounded-3xl border border-white/10 bg-white/5 p-6 text-white backdrop-blur-sm md:flex-row md:items-center md:justify-between"
        >
          <div className="space-y-2">
            <h2 className="text-lg font-semibold">Have a challenge in mind?</h2>
            <p className="text-sm text-white/70 md:text-base">
              I help teams ship responsible AI and backend systems—whether you need a proof-of-concept, a scaling partner, or a production launch.
            </p>
          </div>
          <Link
            to="/#contact"
            className="inline-flex items-center justify-center rounded-full bg-[#FF6B35] px-6 py-3 text-sm font-semibold text-black shadow-[0_12px_36px_rgba(255,90,28,0.5)] transition hover:shadow-[0_18px_44px_rgba(255,90,28,0.6)]"
          >
            Book a call
          </Link>
        </motion.div>
