  ...
  return (
    <section className="relative min-h-screen w-full overflow-hidden bg-black">
      ...
      <motion.div
        ...
        className="relative z-10 mx-auto flex min-h-screen w-full max-w-5xl flex-col items-center justify-center gap-6 px-6 text-center text-white"
      >
        <SplitText
          text={`Hi, I’m ${site.NAME}`}
          className="!block text-4xl md:text-6xl font-extrabold leading-tight tracking-tight drop-shadow-[0_0_25px_rgba(255,107,53,0.45)]"
          delay={90}
          duration={0.6}
          ease="power3.out"
          splitType="chars"
        ...
        >
          <span className="text-[#FF6B35]">Python</span> &amp; <span className="text-[#FF6B35]">AI/ML</span> Engineer
        </motion.h2>
        ...
        <motion.p
          ...
          className="mx-auto max-w-xl text-base md:text-lg text-white/80"
        >
          <Typing
