...
export const content = {
  ...
  capabilities: [
    ...
    },
    {
      ...
      category: 'Backend',
      bullets: [
        'Scalable Web Applications (booking systems, Appointments scheduling systems etc.)',
    ...
    },
    {
      ...
      description:
        'Developed automated workflow systems to streamline operations and eliminate manual intervention, enhancing efficiency and reducing errors..',
      category: 'Product Growth',
      bullets: [
        "Automation workflow systems (zapier, n8n)"
      ],
      icon: 'Sparkles',
    },
