...
export const content = {
  ...
  achievements: {
    certifications: [
      ...
      {
        id: 'forage',
        title: 'Data labelling job simulation',
        issuer: 'Forage Academy',
        year: '2026',
        summary: 'Gained hands-on experience in human-AI collaboration, foundational to roles in AI ops, trust & safety, and machine learning support.',
        badgeImage: 'https://res.cloudinary.com/dol8jpqwr/image/upload/v1768760228/4-Key-Steps-in-Data-Labeling-760px_wp1ui8.jpg',
        credentialUrl: 'https://acesse.one/AERtu',
        category: 'AI/ML',
      },
      {
        id: 'pytorch',
